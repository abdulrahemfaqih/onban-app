...
@section('content')
    ...
    <form class="mx-auto w-3/4 xl:w-1/4  xl:mx-auto lg:w-2/3 lg:mx-auto " method="post" action="{{ route('register') }}"
        autocomplete="off">
        @csrf
        <div class="w-full  ">
            ...
            <div class="flex items-center gap-4 me-4 mb-6">
                <div>
                    ...
                    <label for="orange-radio"
                        class="ms-2 text-sm font-medium text-gray-500 dark:text-gray-300">Laki-laki</label>
                </div>
                <div>
                    <input id="orange-radio" type="radio" value="Perempuan" name="jenis_kelamin"
                        class="w-4 h-4 text-orange-500 bg-gray-100 border-gray-300 focus:ring-orange-500 dark:focus:ring-orange-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="orange-radio"
                        class="ms-2 text-sm font-medium text-gray-500 dark:text-gray-300">Perempuan</label>
                </div>
            </div>
            <div class="flex justify-center flex-col ">
                ...
                <span
                    class="flex justify-center mt-2 mb-2 text-[12px] px-3 font-medium text-gray-900 bg-white left-1/2 dark:text-white dark:bg-gray-900">Sudah
                    Punya Akun? <a href="{{ route('login') }}" class="text-cyan-600 pl-1"> Login</a></span>
            </div>
        </div>
