    ...
    <div class="form-coment-container border-4 border-primary w-[90%] text-center rounded-md p-3 text-secondary">
        <div class="form-coment">
            ...
            <div class="form-container">
                <form action="{{ route('ulasan-store', $order->id_order) }}" method="post" class="flex flex-col gap-4 justify-center">
                    @csrf
                    ...
                    <button type="submit" class="bg-primary rounded-md border-2 border-primary hover:bg-orange-200">Kirim</button>
                    <a href="{{ route('orderHistory') }}" class="btn cancel border-primary border-2 rounded-md">Cancel</a>
                </form>
            </div>
